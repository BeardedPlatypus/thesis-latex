\begin{figure}[t]
  ...
  \begin{subfigure}[b]{\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \node (legend:2) at (0.1\textwidth, -10pt) [legend-point, fill={GraphGreen}, label=right:{\footnotesize Tiled Shading - $32 \times 32$px tegels}] {};
      \node (legend:3) at (0.1\textwidth, -20pt) [legend-point, fill={GraphRed},   label=right:{\footnotesize Clustered Shading - $8 \times 8$px tegels}] {};

      \node (legend:4) at (0.5925\textwidth,  -0pt) [legend-point, fill={GraphPurple}, label=right:{\footnotesize Clustered Shading - $16 \times 16$px tegels}] {};
      \node (legend:5) at (0.5925\textwidth, -10pt) [legend-point, fill={GraphYellow}, label=right:{\footnotesize Clustered Shading - $32 \times 32$px tegels}] {};
    \end{tikzpicture}
  \end{subfigure}\hfill\\
  \begin{adjustbox}{minipage=\textwidth, scale=0.55}
    \begin{subfigure}[b]{0.8\textwidth}
      ...
      \input{./img/raw/cs-lc-frames/deferred/frames_320_spaceship-indoor.pdf_tex}
  ...
  \begin{adjustbox}{minipage=\textwidth, scale=0.55}
    \begin{subfigure}[b]{0.8\textwidth}
      \centering
      \def\svgwidth{\textwidth}
      \input{./img/raw/cs-lc-frames/deferred/frames_2560_spaceship-indoor.pdf_tex}
  ...
  \begin{adjustbox}{minipage=\textwidth, scale=0.55}
    \begin{subfigure}[b]{0.8\textwidth}
      \centering
      \def\svgwidth{\textwidth}
      \input{./img/raw/cs-lc-frames/deferred/frames_320_pipers-alley.pdf_tex}
  ...
  \begin{adjustbox}{minipage=\textwidth, scale=0.55}
    \begin{subfigure}[b]{0.8\textwidth}
      \centering
      \def\svgwidth{\textwidth}
      \input{./img/raw/cs-lc-frames/deferred/frames_2560_pipers-alley.pdf_tex}
  ...
  \begin{adjustbox}{minipage=\textwidth, scale=0.55}
    \begin{subfigure}[b]{0.8\textwidth}
      \centering
      \def\svgwidth{\textwidth}
      \input{./img/raw/cs-lc-frames/deferred/frames_320_ziggurat-city.pdf_tex}
  ...
  \begin{adjustbox}{minipage=\textwidth, scale=0.55}
    \begin{subfigure}[b]{0.8\textwidth}
      \centering
      \def\svgwidth{\textwidth}
      \input{./img/raw/cs-lc-frames/deferred/frames_2560_ziggurat-city.pdf_tex}
