...
\begin{adjustbox}{minipage=\textwidth, scale=0.8}
  ...
  \begin{tikzpicture}
    ...
    \node at (2.75cm, -1.5cm) (light_list_name) [anchor=west] {Spatiale Hashfuncties:};
...
\node at (11.75cm, -2.8cm) {\scriptsize laag $i$};
\node at (11.75cm, -2.8cm - 3.75cm) {\scriptsize laag $i + 1$};
...
\node at (8.625cm, -3.63cm) (l2) {};
    ...
    \node at (-2.25cm + 10.75cm, -2.5cm + 1.5cm) [] { lengte: $1$ };
  ...
  \caption{Overzicht van de datastructuren gebruikt in Hashed Shading}
  \label{fig:hs-datastructuren-overzicht}
\end{figure}
