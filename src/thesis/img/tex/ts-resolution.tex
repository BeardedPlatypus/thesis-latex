\begin{figure}[t]
  ...
  \begin{subfigure}[b]{\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \node (legend:grid) at (0.1\textwidth, -10pt) [legend-point, fill={GraphGreen}, label=right:{\footnotesize Tiled Shading - $8 \times 8$ px tegls}] {};
  ...
  \begin{adjustbox}{minipage=\textwidth, scale=0.55}
    \begin{subfigure}[b]{0.8\textwidth}
      ...
      \caption{Piper's Alley: $1044$ lichten, Forward.}
  ...
  \begin{adjustbox}{minipage=\textwidth, scale=0.55}
    \begin{subfigure}[b]{0.8\textwidth}
      ...
      \caption{Piper's Alley: $1044$ lichten, Deferred.}
  ...
  \begin{adjustbox}{minipage=\textwidth, scale=0.55}
    \begin{subfigure}[b]{0.8\textwidth}
      ...
      \caption{Ziggurat City: $1170$ lichten, Forward.}
  ...
  \begin{adjustbox}{minipage=\textwidth, scale=0.55}
    \begin{subfigure}[b]{0.8\textwidth}
      ...
      \caption{Ziggurat City: $1170$ lichten, Deferred.}
      \label{fig:ts-resolution-deferred:city}
    \end{subfigure}
  \end{adjustbox}
  \caption{Overzicht van de uitvoeringstijd per resolutie voor de drie testsc\'enes.}
