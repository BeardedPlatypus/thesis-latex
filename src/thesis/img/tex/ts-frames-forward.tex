\begin{figure}[t]
  ...
  \begin{subfigure}[b]{\textwidth}
    ...
    \begin{tikzpicture}
      \node (legend:naive) at (0.1\textwidth,0) [legend-point, fill={GraphBlue}, label=right:{\small Na\"ieve Forward Shading}] {};
      \node (legend:grid) at (0.1\textwidth, -12pt) [legend-point, fill={GraphGreen}, label=right:{\small Forward Tiled Shading - Roosteropbouw}] {};
      \node (legend:tiled) at (0.1\textwidth, -24pt) [legend-point, fill={GraphRed}, label=right:{\small Forward Tiled Shading - Totaal}] {};
    \end{tikzpicture}
  \end{subfigure}\hfill\\
