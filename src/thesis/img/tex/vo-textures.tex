...
\begin{tikzpicture}
    ...
    \draw[-, thin] (line-1-l.center) -- (line-1-r.center) node[pos=0.0125, above right] {\small Huidig};
    
    \node at (-2.0cm, 0.6cm - 3cm) (line-1-l) {};
    \node at (14cm, 0.6cm - 3cm) (line-1-r) {};
    \draw[-, thin] (line-1-l.center) -- (line-1-r.center) node[pos=0.0125, above right] {\small Na\"ief};
    
\node at (-2.0cm, 0.6cm - 5cm - 3 * 1.25cm) (line-1-l) {};
\node at (14cm, 0.6cm - 5cm - 3 * 1.25cm) (line-1-r) {};
    \draw[-, thin] (line-1-l.center) -- (line-1-r.center) node[pos=0.0125, above right] {\small Voorstel};

\node at (0.25cm, 1.5cm) (laag0) {\small laag $0$};
\node at (0.25cm + 2.25cm, 1.5cm) (laag0) {\small laag $1$};
\node at (0.25cm + 6.25cm, 1.5cm) (laag0) {\small laag $i$};
\node at (0.25cm + 10.25cm, 1.5cm) (laag0) {\small laag $i + 1$};
